...
members_v3$bd[members_v3$bd>=100|members_v3$bd<5] <- 0 #arbitrary age range 5 to 99 and 0 as invalid values 
...
date<-(as.Date(as.character(members_v3$registration_init_time), format="%Y%m%d"))
date<-data.frame(date)  
members_v3<-cbind(members_v3,date)
